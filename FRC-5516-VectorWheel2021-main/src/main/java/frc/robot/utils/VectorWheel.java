...
// ShuffleboardTab sTab = Shuffleboard.getTab("Chassis");
// NetworkTableEntry angleEntry = sTab.add("angleFX", 0).getEntry();
// NetworkTableEntry speedEntry = sTab.add("speedFX", 0).getEntry();
...
// angleEntry.setNumber(angleToEncoder(currentAngle));
// speedEntry.setNumber(speed * this.currentDirection);
    ...
    public int getTunringPos() {
        return motorTurning.getSelectedSensorPosition();
    }
}
